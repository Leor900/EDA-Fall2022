...
> **ANSWER:** The columns of the dataset that contain the y coordinate values is dec_long_va (longitud) and the x coordinate values is dec_lat_va (latitud). 
...
>**ANSWER:**  The new field that appear in the dataset created is called "geometry" and the fields that dissapear are "dec_long_va" and "dec_lat_va".
