...
low_f <- c(19, 19, 26, 32, 31, 18, 20, 26, 25, 18) # Low bound for the temperature forecast for next 10 days in Durham in Fahrenheit

high_f <- c(29, 38, 45, 47, 46, 42, 37, 45, 42, 38) # High bound for the temperature forecast for next 10 days in Durham in Fahrenheit

low_c <- c((low_f-32)*(5/9)) # Conversion from Fahrenheit to Celsius for low bound

high_c <- c((high_f-32)*(5/9)) # Conversion from Fahrenheit to Celsius for high bound

temperature_forecast_durham <- data.frame(low_f, high_f, low_c, high_c) # Merged vectors into a data frame

summary(temperature_forecast_durham) # Summary statistics for all the variables

summary(temperature_forecast_durham$low_f) # Summary statistics for the variable low_f

sd(temperature_forecast_durham$high_f) # Standard Deviation for the variable high_f
