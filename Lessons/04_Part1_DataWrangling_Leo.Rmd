...
NTL.phys.data.tuesdaylake.1990to1999 <- filter(NTL.phys.data,lakename=="Tuesday Lake", year4>=1990 & year4<=1999)
...
class(NTL.phys.data$temperature_C)

NTL.phys.data.temperature.desc <- arrange(NTL.phys.data, desc(temperature_C))
  
# Which dates, lakes, and depths have the highest temperatures?

# 1. date= 1998-07-16, East Long Lake, depth=0.5, temperature=34.1
# 2. date= 2002-07-01, Hummingbird Lake, depth=0.0, temperature=31.5
# 3. date= 2002-07-19, Hummingbird Lake, depth=0.0, temperature= 29.0
